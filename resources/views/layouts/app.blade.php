...
<head>
    ...
    {{--    Favicon--}}
    <link rel="icon" href="https://duckduckgo.com/assets/common/dax-logo.svg" type="image/ico">
    <!-- CSRF Token -->
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{asset('logo.png')}}" class="img-fluid" alt="No Image" width="150px">
            </a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        ...
                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('register') }}">{{ __('Job Seeker Register')
                                    }}</a>
                            </li>
                        @endif
                    @else
